...
interface GiaveProductionAppProps {
  machine: string;
  initialDay?: number;
  config: Config;
}

interface GiaveProductionAppState {
  day?: Date;
  schedule?: Schedule;
...
export class GiaveProductionApp extends React.Component<
  GiaveProductionAppProps,
  GiaveProductionAppState
> {
  public static displayName = 'GiaveProductionApp';

  private readonly scheduleStore: ScheduleStore;
  private prodInfoStore: ProdInfoStore | undefined;
  private openedStops = new Map<string, void>();

  public constructor(props: GiaveProductionAppProps) {
    super(props);
