...
CREATE TABLE IF NOT EXISTS `prod_hours` (
...
CREATE TABLE IF NOT EXISTS `colors` (
	...
	`name`	varchar(255) NOT NULL,
	`background_hex`	varchar(255) NOT NULL,
	`text_hex`	varchar(255) NOT NULL,
	`close_hex`	varchar(255) NOT NULL,
	`has_border`	integer NOT NULL,
	`description`	varchar(255) NOT NULL,
	PRIMARY KEY(`ref`)
);
CREATE TABLE IF NOT EXISTS `bobines_quantities` (
	`sold_min`	integer NOT NULL,
	`sold_max`	integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS `refentes` (
	`ref`	varchar(255) NOT NULL,
	`refPerfo`	varchar(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `perfos` (
	`ref`	varchar(255) NOT NULL,
	`decalageInitial`	integer NOT NULL,
	`cale1`	integer,
	`bague1`	integer,
	`cale2`	integer,
	`bague2`	integer,
...
INSERT INTO `refentes` VALUES ('R-140x7','P0001',0,140,140,140,140,140,140,140,NULL,0,FROM_UNIXTIME(1558005719));
INSERT INTO `refentes` VALUES ('R-140x6-Ch60','P0001',0,140,140,140,140,140,140,NULL,60,0,FROM_UNIXTIME(1558005719));
INSERT INTO `refentes` VALUES ('R-180x5','P0002',40,180,180,180,180,180,NULL,NULL,NULL,0,FROM_UNIXTIME(1558005719));
INSERT INTO `refentes` VALUES ('R-150x6','P0003',40,150,150,150,150,150,150,NULL,NULL,0,FROM_UNIXTIME(1558005719));
INSERT INTO `refentes` VALUES ('R-150x4-160-140','P0003',40,150,150,150,150,160,140,NULL,NULL,0,FROM_UNIXTIME(1558005719));
INSERT INTO `refentes` VALUES ('R-210x4-Ch60','P0004',40,210,210,210,210,NULL,NULL,NULL,60,0,FROM_UNIXTIME(1558005719));
INSERT INTO `refentes` VALUES ('R-210-240-210-240','P0004',0,210,240,210,240,NULL,NULL,NULL,NULL,0,FROM_UNIXTIME(1558005719));
INSERT INTO `refentes` VALUES ('R-210-240-190-260','P0004',0,210,240,190,260,NULL,NULL,NULL,NULL,0,FROM_UNIXTIME(1558005719));
INSERT INTO `refentes` VALUES ('R-210x4','P0004',40,210,210,210,210,NULL,NULL,NULL,NULL,0,FROM_UNIXTIME(1558005719));
INSERT INTO `refentes` VALUES ('R-240x3','P0004',0,240,240,240,NULL,NULL,NULL,NULL,NULL,0,FROM_UNIXTIME(1558005719));
INSERT INTO `refentes` VALUES ('R-320-260x2-Ch60','P0005',40,320,260,260,NULL,NULL,NULL,NULL,60,0,FROM_UNIXTIME(1558005719));
INSERT INTO `refentes` VALUES ('R-300x3','P0005',0,300,300,300,NULL,NULL,NULL,NULL,NULL,0,FROM_UNIXTIME(1558005719));
INSERT INTO `refentes` VALUES ('R-320x2-260','P0005',0,320,320,260,NULL,NULL,NULL,NULL,NULL,0,FROM_UNIXTIME(1558005719));
INSERT INTO `refentes` VALUES ('R-320-260x2','P0005',40,320,260,260,NULL,NULL,NULL,NULL,NULL,0,FROM_UNIXTIME(1558005719));
INSERT INTO `refentes` VALUES ('R-260x3-Ch180','P0005',40,260,260,260,NULL,NULL,NULL,NULL,180,0,FROM_UNIXTIME(1558005719));
INSERT INTO `refentes` VALUES ('R-260x3-Ch60','P0005',80,260,260,260,NULL,NULL,NULL,NULL,60,0,FROM_UNIXTIME(1558005719));
INSERT INTO `refentes` VALUES ('R-180-173.3x3-140x2','P0006',0,180,173.3,173.3,173.3,140,140,NULL,NULL,0,FROM_UNIXTIME(1558005719));
INSERT INTO `refentes` VALUES ('R-180-150-130x5','P0007',0,180,150,130,130,130,130,130,NULL,0,FROM_UNIXTIME(1558005719));
INSERT INTO `refentes` VALUES ('R-190-140-130x5','P0007',0,190,140,130,130,130,130,130,NULL,0,FROM_UNIXTIME(1558005719));
INSERT INTO `refentes` VALUES ('R-150x4','P0003',40,150,150,150,150,NULL,NULL,NULL,NULL,0,FROM_UNIXTIME(1558005719));
INSERT INTO `perfos` VALUES ('P0001',240,30,80,60,80,60,80,60,80,60,80,60,80,60,80,0,FROM_UNIXTIME(1558005719));
INSERT INTO `perfos` VALUES ('P0002',240,90,80,100,80,100,80,100,80,100,80,NULL,NULL,NULL,NULL,0,FROM_UNIXTIME(1558005719));
INSERT INTO `perfos` VALUES ('P0003',240,75,80,70,80,70,80,70,80,70,80,70,80,NULL,NULL,0,FROM_UNIXTIME(1558005719));
INSERT INTO `perfos` VALUES ('P0004',240,0,80,85,80,130,80,130,80,130,80,NULL,NULL,NULL,NULL,0,FROM_UNIXTIME(1558005719));
INSERT INTO `perfos` VALUES ('P0005',240,0,80,140,80,210,80,180,80,'',NULL,NULL,NULL,NULL,NULL,0,FROM_UNIXTIME(1558005719));
INSERT INTO `perfos` VALUES ('P0006',240,50,80,100,80,90,80,95,80,75,80,60,80,NULL,NULL,0,FROM_UNIXTIME(1558005719));
INSERT INTO `perfos` VALUES ('P0007',240,50,80,85,80,60,80,50,80,50,80,50,80,50,80,0,FROM_UNIXTIME(1558005719));
